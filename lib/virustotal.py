...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--apikey", help="the apikey to use for this transaction")
    ...
    parser.add_argument("-o", "--one", help="send a single file to scan", metavar="PATH")
    ...
    vt = VirusTotal(args.apikey, args.private, args.verbose)
