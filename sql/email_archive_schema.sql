...
--
-- Host: localhost    Database: email-archive-ashland-2
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=3275 DEFAULT CHARSET=latin1;
...
CREATE TABLE `archive_index` (
  `field` enum('env_from','env_to','body_from','body_to','subject','decoded_subject','message_id') NOT NULL,
...
-- Dump completed on 2018-02-18 16:14:05
